      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-3xl font-bold leading-snug tracking-tight text-gray-800 break-words hyphens-auto sm:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
